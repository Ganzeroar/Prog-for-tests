...
import json
import time
import modul_click_theme_start_test
...
class MainCode(QWidget):
    ...
    def labels(self):
        ...
        self.label_subject.setFont(font_obj_for_label)
        self.label_subject.move(110, 103)
        self.label_subject.setFixedSize(300, 40)
        self.label_subject.hide()
        self.label_theme = QtWidgets.QLabel("Выбор темы", self)
        font_obj_for_label = QtGui.QFont('Segoe UI', pointSize = 15)
        self.label_theme.setFont(font_obj_for_label)
        self.label_theme.move(600, 100)
        self.label_theme.setFixedSize(300, 40)
    ...
    def buttons(self):
        ...
        #font_obj_for_label = QtGui.QFont('Segoe UI', pointSize = 15)
        #self.button_choose_test.setFont(font_obj_for_label)
        ...
        for x in ultra_dict.items():
            ...
            self.button_of_subject.move(26, x_coord_for_btn_subj)
            self.button_of_subject.setFixedSize(469, 44)
       ...
       ####################################################################
        ...
        x_coord_for_btn_subj_for_edit = 170    
        for subj_for_edit in ultra_dict.items():
            ...
            self.button_of_subject_for_edit.move(26, x_coord_for_btn_subj_for_edit)
            self.button_of_subject_for_edit.setFixedSize(469, 44)
        ...
        def click_theme_start_test(self):
            #modul_mod_win_append_subj.mod_win_append_subj(5, list_for_theme_buttons, self)
            #print(1)
            modul_click_theme_start_test.click_theme_start_test(self, list_for_theme_buttons)
            '''
            ...
            for x in list_for_theme_buttons:
                if x.isChecked():
                    ...
                    font_obj_for_label = QtGui.QFont('Segoe UI', pointSize = 14)
                    ...
                    if len(list_for_questions) == 0:
                        ...
                        for quest in list_for_questions:
                            ...
                            quest_label.setFixedSize(780, 37)
                            ...
                            start_test_button.move(370, 400)
                            start_test_button.setFixedSize(300, 100)
        ...
        for x in ultra_dict.keys():
            ...
            for y in ultra_dict[x]:
                ...
                self.button_of_theme.move(520, x_coord_for_btn_theme)
                self.button_of_theme.setFixedSize(469, 44)
